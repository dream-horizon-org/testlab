...
/**
 * Factory class for building filter queries for experiments.
 * Applies decorators based on the filter criteria in the request.
 *
...
public class FilterExperimentsQueryFactory {
  ...
  /**
   * Builds a SQL query based on the filter criteria in the request.
   * Applies decorators for name, type, status, tag, and owner filters,
   * followed by grouping, ordering, and pagination.
   *
