...
/**
 * Decorator that adds a tag filter to the query.
 * Supports multiple tags as a comma-separated list.
 *
...
public class TagFilterQueryDecorator extends FilterQueryDecorator {
  ...
  /**
   * Appends a tag filter clause to the wrapped query.
   * Formats multiple tags for use in an IN clause.
   *
