...
public class StatusTransitionRule implements UpdateValidationRule {
  ...
  private static final Map<ExperimentStatus, Set<ExperimentStatus>> ALLOWED_TRANSITIONS =
      Map.of(
          ...
          Set.of(ExperimentStatus.PAUSED, ExperimentStatus.CONCLUDED, ExperimentStatus.TERMINATED),
          ExperimentStatus.CONCLUDED,
          Set.of(ExperimentStatus.TERMINATED),
          ExperimentStatus.PAUSED,
          Set.of(ExperimentStatus.LIVE, ExperimentStatus.TERMINATED));
