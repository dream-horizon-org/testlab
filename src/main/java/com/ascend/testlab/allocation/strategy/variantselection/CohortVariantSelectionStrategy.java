...
import com.ascend.testlab.allocation.strategy.variantassignment.VariantAssignmentStrategy;
import com.ascend.testlab.allocation.strategy.variantassignment.VariantAssignmentStrategyFactory;
...
public class CohortVariantSelectionStrategy implements VariantSelectionStrategy {
  ...
  public String selectVariant(Experiment experiment, String userId, List<String> userCohorts) {
    ...
    List<Variant> variants = convertVariantMapToList(experiment.getVariants());
    ...
    String selectedVariantName = findVariantNameInMap(experiment.getVariants(), selectedVariant);
